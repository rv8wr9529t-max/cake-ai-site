...
ALTER TABLE `conversations` ADD CONSTRAINT `conversations_modelId_models_id_fk` FOREIGN KEY (`modelId`) REFERENCES `models`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
